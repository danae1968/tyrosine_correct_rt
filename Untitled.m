...
rt_all_subs=[correct_all_subs;sub(j).rt];
...
average_correct_ignore_all_subs=mean(correct_all_subs(ignore));
average_correct_no_inter_all_subs=mean(correct_all_subs(no_inter));
average_correct_update_all_subs=mean(correct_all_subs(update));
...
average_rt_ignore_all_subs=mean(rt_all_subs(ignore));
average_rt_no_inter_all_subs=mean(rt_all_subs(no_inter));
average_rt_update_all_subs=mean(rt_all_subs(update));
